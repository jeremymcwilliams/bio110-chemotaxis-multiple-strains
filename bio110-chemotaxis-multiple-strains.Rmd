...
## Chemotaxis Assay - Multiple Strains
...
# testing loading multiple strains & anova

osm1<-read_csv("osm1.csv");

osm5<-read_csv("osm5.csv");
dyf2<-read_csv("dyf2.csv")

osm1
osm5
dyf2

combined<-rbind(osm1, osm5, dyf2)
combined
